...
function HatPartials(width,mode) {
    ...
    switch (mode) {
        ...
        case 1:
            ...
            break;
        case 2:
            filterGrow(partials, length, 0.01);
            filterDisorganise(partials, length, 0.6, 3);
...
function PipePartials(width,mode) {
...
function SetPeriodicWave(osc, partials, phase){
    var fftSize = 4096;
    ...
    periodicWaveSize = partials.length + 1;
    ...
    var coefs = [real, imag];
    var periodicWave = Tone.context.createPeriodicWave(coefs[0], coefs[1]);
